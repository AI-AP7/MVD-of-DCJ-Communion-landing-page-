  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#1a0f08]">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <div 
          className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-40 scale-110 blur-[2px]"
          style={{ backgroundImage: `url('https://images.unsplash.com/photo-1529119368496-2dfda6ec2804?q=80&w=2070&auto=format&fit=crop')` }}
        />
